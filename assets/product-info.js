if (!customElements.get('product-info')) {
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      updateCustomProductLabel(html) {
        const currentProductLabel = this.querySelector('#custom-product-label');
        const newProductLabel = html.querySelector('#custom-product-label');
        if (currentProductLabel && newProductLabel) {
          HTMLUpdateUtility.viewTransition(
            currentProductLabel,
            newProductLabel
          );
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          this.updateCustomProductLabel(html);
